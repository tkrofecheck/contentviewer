...
function injectVideoCSS() {
  // This allows an embedded stylesheet to be appended to the iframe body tag, created by colorbox
  //  -- HTML5 video will now fit the iframe without needing scrollbars
  var styleTag = document.createElement("style") 
  styleTag.type = "text/css";
  styleTag.innerHTML = "video { width:100%;height:100%; }";
  frames['frame1'].document.body.appendChild(styleTag);
}
